...
public class UpdateSecurePassword {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String backupQuery = "CREATE TABLE customers_backup AS SELECT * FROM customers;";
        int backupResult = statement.executeUpdate(backupQuery);
        System.out.println("altering customers table schema completed, " + backupResult + " rows affected");
